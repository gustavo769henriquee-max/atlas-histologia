        ...
        <div class="form-card">
          ...
          <div class="form-card-title">
            ...
            <div>
              ...
              <p>
                Escolha uma logo para representar o Atlas.
              </p>
            </div>
          ...
          <div class="logo-editor">
            ...
            <div class="logo-editor-info">
              ...
              <label class="logo-upload-button">
                ...
                <input
                  id="config-logo" data-logo-url="${logoUrlInicial}"
                  type="file"
              ...
              <p class="logo-help">
                PNG, JPG ou WebP. Recomendamos uma imagem
                quadrada com fundo transparente.
              </p>
              <div class="logo-size-control">

                <div class="logo-size-header">

                  <label for="config-logo-tamanho">
                    Tamanho da logo
                  </label>
                ...
                <input
                  id="config-logo-tamanho" value="${config.logo_tamanho || 100}"
                  type="range"
                  min="50"
                  max="150"
                  step="1"
        ...
        <div class="form-card">
          ...
          <div class="form-card-title">
            ...
            <div>
              ...
              <p>
                Altere os textos exibidos para os visitantes.
              </p>
            </div>
        ...
        <div class="form-card">
          ...
          <div class="form-card-title">
            ...
            <div>
              ...
              <p>
                Personalize a identidade visual do Atlas.
              </p>
            </div>
